  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f5f0e8", fontFamily: "'DM Sans', 'Helvetica Neue', sans-serif" }}>
      ...
      <div className="vly-page" style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        <p style={{ fontSize: 16, color: "#8a9e7a", marginBottom: "3rem" }}>From brief to booked — here's exactly how we take the work off your plate.</p>
        ...
        <div style={{ background: "#2c3a1e", borderRadius: 12, padding: "3rem", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 15, color: "#8a9e7a", maxWidth: 420, margin: "0 auto 1.75rem", lineHeight: 1.8 }}>Send us your brief and we'll have a curated shortlist of London venues back to you within 24 hours. It's completely free.</p>
